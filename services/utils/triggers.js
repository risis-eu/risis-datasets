        ...
        case 'http://rdf.risis.eu/application/decisionDSO':
            ...
            notifList.forEach(function(el) {
                if(el.type !== 'USER'){
                    ...
                    handleEmail.sendMail('applicationDecisionChange', 'datasets@risis.eu', el.mbox, 'RISIS ['+el.type +'] Decision Update for Visit Request Application #' + appName + 'by DSO: ' + newObjectValue, etext, etext);
                }
            });
            break;
        case 'http://rdf.risis.eu/application/decisionPRB':
            ...
            notifList.forEach(function(el) {
                if(el.type !== 'USER'){
                    ...
                    handleEmail.sendMail('applicationDecisionChange', 'datasets@risis.eu', el.mbox, 'RISIS ['+el.type +'] Decision Update for Visit Request Application #' + appName + 'by PRB: '+ newObjectValue, etext, etext);
                }
            });
            break;
        case 'http://rdf.risis.eu/application/decisionFCB':
            ...
            notifList.forEach(function(el) {
                if(el.type !== 'USER'){
                    ...
                    handleEmail.sendMail('applicationDecisionChange', 'datasets@risis.eu', el.mbox, 'RISIS ['+el.type +'] Final Decision for Visit Request Application #' + appName + 'by FCB:', etext, etext);
                }else{
                    etext = 'Dear '+ el.firstName +',\n Final decision for your visit request application #' + appName + ' is "'+newObjectValue+'": \n \n '+ appLink +' \n \n Please sign in to RISIS Datasets Portal with your username ('+el.username+'): \n \n http://datasets.risis.eu/ \n \n and check the your application details. \n \n -- on behalf of RISIS Datasets Portal';
                    handleEmail.sendMail('applicationDecisionChange', 'datasets@risis.eu', el.mbox, 'RISIS ['+el.type +'] Final Decision for your Visit Request Application #' + appName , etext, etext);
                }
            });
            break;
        default:
